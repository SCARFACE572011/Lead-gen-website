---
title: "Prospecting Local Clients by ZIP Code: A Playbook"
...
cover: "/img/aerial.jpg"
excerpt: "Why territory-based prospecting beats random cold lists, and a weekly ZIP-by-ZIP routine that fills your pipeline with local clients."
---
...
## Set your radius, then work one area at a time
...
If you want the full breakdown of what moves a score and how to read it, we wrote a companion piece: [lead scoring, explained](/blog/lead-scoring-explained). Pair it with the broader [local lead generation guide](/blog/local-lead-generation-guide) for the strategy around it.
